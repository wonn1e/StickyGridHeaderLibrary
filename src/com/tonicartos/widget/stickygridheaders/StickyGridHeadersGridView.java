...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener, 
    ...
    private int mDirection = OnScrollDirectionChangeListener.DIRECTION_NONE; 
     
    private OnScrollDirectionChangeListener mScrollDirectionChangeListener; 
    ...
    public StickyGridHeadersGridView(Context context, AttributeSet attrs, int defStyle) { 
        ...
        mDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() { 
                ...
                public boolean onScroll(MotionEvent e1, MotionEvent e2, 
                        ...
                        int direction; 
                        if (e1.getY() > e2.getY()) { 
                                direction = OnScrollDirectionChangeListener.DIRECTION_BOTTOM_UP; 
                        } else { 
                                direction = OnScrollDirectionChangeListener.DIRECTION_TOP_DOWN; 
                        } 
                        if (mDirection != direction) { 
                                mDirection = direction; 
                                if (mScrollDirectionChangeListener != null) { 
                                        mScrollDirectionChangeListener.onScrollDirectionChanged(mDirection); 
                                } 
                        } 
